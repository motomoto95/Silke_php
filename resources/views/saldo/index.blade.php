...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <form action="{{ route('csaldo.index') }}" method="GET" role="search">
                    <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control mr-2" name="name" placeholder="Nombre o nick del usuario" id="term">
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->saldo }}</td>
                            <td>
                                <a href=""  class="btn btn-outline-success" data-toggle="modal" data-target="#editarModal{{$user->id}}" data-nick="{{$user->nick}}" > Agregar Saldo</a>
                                    <div class="modal fade" id="editarModal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{route('csaldo.update',$user->id)}}">
                                                @csrf @method('PUT')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="recipient-name" value="{{$user->nick}} " disabled>
                                                </div>
                                                <div class="form-group">
